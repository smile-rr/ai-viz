  ...
  p3: {
    ...
    bets: {
      ...
      items: [
        ...
        { title:'Data Viz 团队的价值从"交付报表"转向"建设平台能力"', body:'随着 AI 承担越来越多的临时查询，团队的杠杆来自：定义语义层标准、建立 Metric 规范、确保 AI 系统产出可信赖的结果——而不是执行更多报表请求。这是更有价值的角色，但需要从 P1 阶段就有意识地开始这个转变，而不是等平台建好再说。' },
      ],
    },
  },
};
